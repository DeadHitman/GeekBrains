...
public class SettingsWindow extends JFrame {
    ...
    //Конструктор принимающий на вход объект gameWindow
    SettingsWindow(GameWindow gameWindow) {
        this.gameWindow = gameWindow;
        //установка размера
        setSize(WINDOW_WIDTH, WINDOW_HEIGHT);

        //Тип объекта (Прямоугольник),размещение его относительно центра gameWindow
        ...
        setLayout(new GridLayout(10, 1)); //Сетка на 10 строк и 1 столбец
        addGameModeControls();
    ...
    //Метод отвечающий за режим игры
    private void addGameModeControls() {
        add(new JLabel("  Choose game mode:"));
        humVSAI = new JRadioButton("Human vs. AI", true);  // установка по умолчанию радиокнопки
    ...
    //Метод отвечающий за скролл размера поля
